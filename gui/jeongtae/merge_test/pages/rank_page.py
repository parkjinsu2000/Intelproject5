...
class RankPage(QWidget):
    ...
    BASE_VIDEO_DIR = os.path.abspath(
        "/home/ubuntu/workspace_intel/Intelproject5/gui/jeongtae/merge_test/resources/videos"
    )  # 원하는 기본 절대경로
    ...
    RANK_FILE = os.path.join(RANK_DIR, "rank_video_list.txt")
    ...
    def load_ranking(self):
        ...
        with open(self.RANK_FILE, "r", encoding="utf-8") as f:
            for line in f:
                ...
                # 상세 기록 파일 확인
                details_file = os.path.join(self.DETAILS_DIR, f"{line}.txt")
    ...
    def on_video_selected(self, item):
        ...
        details_file = os.path.join(self.DETAILS_DIR, f"{video_name}.txt")
