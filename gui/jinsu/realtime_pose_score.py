...
def main():
    ...
    while True:
        ...
        retval, buffer = cv2.imencode('.jpg', disp)
        if retval:
    ...
    while True:
        ...
        if do_score:
            ...
            if (lastR["kps"] is not None) and (lastU["kps"] is not None):
        ...
        _, buffer = cv2.imencode('.jpg', disp)
        b64 = base64.b64encode(buffer).decode('utf-8')
        print(b64)
        sys.stdout.flush()
